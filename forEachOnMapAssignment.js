console.log("======================Assignment: forEach( ) on map===========================");
class Employee{
...
console.log("Get the list of all employee names & log new array on console.");
let newArray=array_employee.map((currentValue,index)=>{
...
newArray=array_employee.map((currentValue,index)=>{
